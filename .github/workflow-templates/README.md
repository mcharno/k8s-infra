...
See [ARGOCD-GITHUB-ACTIONS.md](../../docs/argocd-github-actions.md) for complete setup guide.
...
- **Full setup guide:** [ARGOCD-GITHUB-ACTIONS.md](../../docs/argocd-github-actions.md)
